...
namespace GassoCo.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.ProductGroupId = new SelectList(db.ProductGroups.Where(p => p.IsDelete == false), "Id", "Title");
            return View();
        }
        ...
        public ActionResult Edit(Guid? id)
        {
            ...
            ViewBag.ProductGroupId = new SelectList(db.ProductGroups.Where(p => p.IsDelete == false), "Id", "Title", product.ProductGroupId);
            return View(product);
        }
        ...
        public ActionResult List(string language, Guid id)
        {
            ...
            if (language == "fa")
            {
                ViewBag.Title = productListViewModel.ProductGroup.Title + " | گروه صنعتی گازسو";
                ViewBag.Description = productListViewModel.ProductGroup.MetaDescription;
            }
            else
            {
                ViewBag.Title = productListViewModel.ProductGroup.TitleEn + " | gasso group";
                ViewBag.Description = productListViewModel.ProductGroup.MetaDescriptionEn;
            }
        ...
        public ActionResult Details(string language, Guid productGroupId, Guid? id)
        {
            ...
            if (language == "fa")
            {
                ViewBag.Title = product.Title + " | گروه صنعتی گازسو";
                ViewBag.Description = product.MetaDescription;
            }
            else
            {
                ViewBag.Title = product.TitleEn + " | gasso group";
