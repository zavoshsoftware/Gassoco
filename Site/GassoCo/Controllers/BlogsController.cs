...
namespace GassoCo.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public ActionResult List(string language)
        {
            ...
            if (language == "fa")
            {
                ViewBag.Title = "اخبار گروه صنعتی گازسو | تجهیزات آشپزخانه صنعتی";
            }
            else
            {
                ViewBag.Title = "gasso group news | restaurants equipment";
            }
        ...
        public ActionResult Details(string language, Guid? id)
        {
            ...
            if (language == "fa")
            {
                ViewBag.Title = blog.Title + " | گروه صنعتی گازسو";
                ViewBag.Description = blog.MetaDescription;
            }
            else
            {
                ViewBag.Title = blog.TitleEn + " | gasso group news";
