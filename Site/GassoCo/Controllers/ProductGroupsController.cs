...
namespace GassoCo.Controllers
{
    ...
    public class ProductGroupsController : Controller
    {
        ...
        public ActionResult List(string language,Guid id)
        {
            ...
            if (language == "fa")
            {
                ViewBag.Title = productGroupListViewModel.CurrentProductGroup.Title + " | شرکت گازسو";
                ViewBag.Description = productGroupListViewModel.CurrentProductGroup.MetaDescription;

            }
            else
            {
                ViewBag.Title = productGroupListViewModel.CurrentProductGroup.TitleEn + " | gasso group";
        ...
        public ActionResult ListForParent(string language)
        {
            ...
            if (language == "fa")
            {
                ViewBag.Title = "لیست تجهیزات آشپزخانه صنعتی | شرکت گازسو";
            }
            else
            {
                ViewBag.Title = "Industrial kitchen equipment| gasso group";
            }
            return View(productGroupListViewModel);
        }
